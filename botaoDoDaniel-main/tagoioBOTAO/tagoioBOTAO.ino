...
//variáveis para Json
char json_btn[100];
char json_pessoas2[1000];
char recebido;
//variáveis internas
int valor_btn;
int pessoasDentro2 = 0;
...
void converte_json()
{
  ...
  StaticJsonDocument<300> sjson_pessoas2;

  sjson_pessoas2["variable"] = "Convidados2";
  sjson_pessoas2["value"] = pessoasDentro2;
  serializeJson(sjson_pessoas2, json_pessoas2);
}


void envia_msg()
{
  client.publish("/botao", json_pessoas2); // You can activate the retain flag by setting the third parameter to true
}
